...
public class customer {
    ...
    public customer(String customer_Code, String customer_name, String customer_Number, String plant_Name, String date_planted, String lastly_Watered, String lastly_sprayed) {
